...
- **Website Pack has four recipes** — routed behind flag: **`site.landing-page-core`**, **`site.dashboard-ui-core`**, **`app.saas-dashboard-core`**, **`app.admin-dashboard-core`**. **139 modules** total under `website-pack/`; v1 default preserved when flag is off; no templates or starter source files.
...
| **Website Pack** | [website-pack/](website-pack/) — **4 recipes**: `site.landing-page-core` (routed), `site.dashboard-ui-core` (routed), `app.saas-dashboard-core` (routed behind flag), `app.admin-dashboard-core` (routed behind flag); **139 modules** |
...
Routed recipe coverage remains: all sixteen Game Pack recipes plus `site.landing-page-core`, `site.dashboard-ui-core`, `app.saas-dashboard-core`, and `app.admin-dashboard-core` behind `HAM_BUILD_REGISTRY_V2_ENABLED`. v1 remains default when the flag is off.
