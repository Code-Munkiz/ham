...
- **Website Pack skeleton landed** — **`site.landing-page-core`** authored schema-only under `website-pack/` (**29 modules**); **not routed**; v1 default preserved; no templates or starter source files.
...
| **Website Pack** | [website-pack/](website-pack/) — **1 recipe** (`site.landing-page-core`, schema-only, **not routed**), **29 modules** |
