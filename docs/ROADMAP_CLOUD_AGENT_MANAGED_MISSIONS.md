...
**Related:** `GAPS.md`, `VISION.md` (transitional state table), `docs/CONTROL_PLANE_RUN.md` (factual run records vs. mission graph), [`docs/CURSOR_CLOUD_AGENT_LAUNCH.md`](CURSOR_CLOUD_AGENT_LAUNCH.md) (operator runbook: preview → `cursor_agent_launch` → verification).
