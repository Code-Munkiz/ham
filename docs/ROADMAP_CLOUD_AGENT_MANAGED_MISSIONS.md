...
**Related:** `GAPS.md`, `VISION.md` (transitional state table), `docs/CONTROL_PLANE_RUN.md` (factual run records vs. mission graph), `docs/LAUNCH_CURSOR_CLOUD_AGENT.md` (how to launch from Ham: API, chat, prerequisites).
