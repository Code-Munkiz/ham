...
**Related:** `GAPS.md`, `VISION.md` (transitional state table), `docs/CONTROL_PLANE_RUN.md` (factual run records vs. mission graph), `docs/HAM_CLOUD_AGENT_ROUTING_SMOKE.md` (Workspace Chat stream → operator / Cloud Agent router), `docs/HAM_CHAT_CONTROL_PLANE.md` (preview / confirm / launch contract).
