"""DEPRECATED INTERNAL ONLY — JSON artifact native builder (do not use in product).

Normal chat and native build paths must not import this module. It exists for
explicit regression tests of the retired ``complete_artifact_turn`` file-bundle
transport only.
"""
