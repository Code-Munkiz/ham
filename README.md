...
- **Documentation index (deploy, chat, missions, desktop)**: [docs/README.md](docs/README.md)
...
- `src/tools/droid_executor.py` — Bridge v0 Droid subprocess backend (bounded `subprocess.run`, capped I/O; meaningful Factory runs need profile argv + installed CLI — see `VISION.md`)
