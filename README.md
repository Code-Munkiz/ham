...
- **Luv Social (extracted):** autonomous Telegram/X/Discord social-agent ops live in the standalone [luv-protocol/luv-social](https://github.com/luv-protocol/luv-social) repo. HAM keeps builder/workspace/agent platform only; see [docs/GOHAM_SOCIAL_EXTRACTION.md](docs/GOHAM_SOCIAL_EXTRACTION.md).
