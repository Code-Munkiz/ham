...
- **Deferred (unchanged direction):** no second orchestration harness, no FTS5 durable learning persistence yet, no Phase 4 Droid execution-safety hardening until mutating missions and policy surfaces need it beyond Bridge v0 defaults.
...
expansion waits on richer Bridge/mission coverage and supervisory integration tests.
**Next (as missions expand):** refresh-after-tool semantics, subprocess/output
envelope assertions, optional end-to-end supervisory smoke without orchestration redesign.
