...
- `docs/MISSION_AWARE_FEED_CONTROLS.md` — live mission feed and operator actions scoped to one `mission_registry_id`; transcript rendering from bounded feed events
