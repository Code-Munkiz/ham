...
- `docs/CURSOR_CLOUD_AGENT_LAUNCH.md` — short operator runbook: `POST /api/cursor/agents/launch` vs chat `cursor_agent_preview` / `cursor_agent_launch`, Clerk + tokens, links to deploy docs
