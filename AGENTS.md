...
- `docs/CURSOR_CLOUD_AGENT_LAUNCH.md` — operator runbook: launch a Cursor Cloud Agent via chat `operator` (preview / `cursor_agent_launch`), tokens, vs `/api/cursor/*` proxy path
