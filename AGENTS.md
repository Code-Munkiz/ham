...
- `docs/LAUNCH_CURSOR_CLOUD_AGENT.md` — how to launch a Cursor Cloud Agent from Ham (API vs chat, `CURSOR_API_KEY` + `HAM_CURSOR_AGENT_LAUNCH_TOKEN`, links to deploy runbooks)
