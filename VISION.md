...
| GoHAM Social (extracted) | [luv-protocol/goham-social](https://github.com/luv-protocol/goham-social) — was `src/ham/ham_x/`, `src/api/social.py`, workspace Social UI | **Extracted (Mission 20):** autonomous Telegram/X/Discord social ops moved out of HAM; HAM keeps builder/workspace/agent platform only. Legacy `/workspace/social` shows moved pointer; see `docs/GOHAM_SOCIAL_EXTRACTION.md`. Mission 21 continues Telegram autonomy in the standalone repo |
