...
| Luv Social (extracted) | [luv-protocol/luv-social](https://github.com/luv-protocol/luv-social) — was `src/ham/ham_x/`, `src/api/social.py`, workspace Social UI | **Extracted (Mission 20):** autonomous Telegram/X/Discord social ops moved out of HAM; HAM keeps builder/workspace/agent platform only; see `docs/GOHAM_SOCIAL_EXTRACTION.md`. Telegram autonomy continues in the standalone repo |
