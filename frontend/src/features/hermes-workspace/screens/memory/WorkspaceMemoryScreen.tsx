/** Memory: search and edit agent memory notes and preferences. */
import * as React from "react";
import { Brain, ChevronDown, ChevronUp, Pencil, Search } from "lucide-react";
    ...
    return (
      ...
      >
        <WorkspaceSurfaceStateCard
          title="Memory is unavailable right now."
          description="Other workspace surfaces still work. Retry to reconnect."
          tone="amber"
    ...
    >
      ...
      >
        ...
        <p className="mt-0.5 text-xs text-[var(--theme-muted)]">
          Search and edit notes and preferences your agents remember between sessions.
        </p>
      </div>
      <div
              ...
              <div className="max-h-72 space-y-1 overflow-y-auto pr-1 md:h-full md:max-h-none">
                ...
                {!loading && fileItems.length === 0 && (
                  <div className="space-y-1.5 rounded-lg border border-dashed border-white/15 px-3 py-3 text-xs text-[var(--theme-muted)]">
                    ...
                    <p>
                      Memory storage is connected, but no entries are available. Use New to create a
                      note.
                    </p>
                  </div>
                )}
