    ...
    case "voice":
      return (
        <WorkspaceSettingsReadOnlyCard>
          <WorkspaceSettingsSectionHeader
            title="Voice"
            subtitle="Upstream configures STT/TTS in HermesConfigSection (activeView voice). HAM does not run voice capture or synthesis in the browser workspace shell."
          ...
          <div className="mt-6 space-y-3">
            <WorkspaceSettingsFieldRow
              ...
              value="Unavailable"
              hint="No STT pipeline is exposed to this UI."
            />
            <WorkspaceSettingsFieldRow
              label="Text-to-speech"
              value="Unavailable"
              hint="No TTS pipeline is exposed to this UI."
            />
            {catalog ? (
              <WorkspaceSettingsFieldRow
                label="Text chat gateway (related)"
                value={isDashboardChatGatewayReady(catalog) ? "Ready" : "Not ready"}
                hint="Informational — text chat via GET /api/models readiness, not voice."
              />
            ) : null}
          </div>
        </WorkspaceSettingsReadOnlyCard>
